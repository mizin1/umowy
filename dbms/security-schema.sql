...
drop table SECURITY_RESOURCE_GROUP;
...
(
	...
	MAX_INACTIVE_INTERVAL  integer NOT NULL DEFAULT 900,
	ACCESS_COUNTER bigint NOT NULL,
...
drop sequence security_user_sequence;
create sequence security_user_sequence;

drop sequence security_permission_sequence;
create sequence security_permission_sequence;

drop sequence security_role_sequence;
create sequence security_role_sequence;

drop sequence security_resource_group_sequence;
